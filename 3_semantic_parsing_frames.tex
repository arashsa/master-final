...
\paragraph{Peking} This team used the graph-to-tree transformation of \citeA{Du:Peking:14} as a basis for their system. This approach converts the training data that consists of semantic dependency graphs, into tree structures. After the conversion is done, well-established methods for parsing dependency trees are used in order to train a parser. 

\paragraph{Riga} As the team behind Peking, this team also used the graph-to-tree transformation of \citeA{Du:Peking:14} as a basis for their system. \cite{Barzdins:Riga:15}.
