...
We will only use the term graph when we are discussion dependency grammar in section \ref{grammar}, in order to simplify our discussion. We do this based on two assumptions:
